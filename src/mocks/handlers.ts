...
const User = [
  ...
  {id: 'mincodin9', nickname: '민코딩', image: '/5Udwvqim.png'},
...
export const handlers = [
  ...
  http.get(`${baseUrl}/api/trends`, ({ request }) => {
    return HttpResponse.json(
      [
        {tagId: 1, title: '민코딩', count: 1264},
        {tagId: 2, title: '원밍', count: 1264},
        {tagId: 3, title: '투밍', count: 1264},
        {tagId: 4, title: '쓰리밍', count: 1264},
        {tagId: 5, title: '포밍', count: 1264},
        {tagId: 6, title: '파이브밍', count: 1264},
        {tagId: 7, title: '식스밍', count: 1264},
        {tagId: 8, title: '세븐밍', count: 1264},
        {tagId: 9, title: '에잇밍', count: 1264},
      ]
    )
  }),
];